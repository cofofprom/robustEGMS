...
reg_param = 0.1
t_dof = 3
experiment_name = 'CH_glassoRobustness_n100'
MAX_WORKERS=32

def run_model(eps, n_model):
    result_metrics = list()

    precision = make_sparse_spd_matrix(N, alpha=d, norm_diag=True)
...
def main():
    ...
    cluster = SLURMCluster(cores=1, memory='16GB', walltime='02:00:00', header_skip=['--mem'], env_extra=[
        "export PYTHONPATH=/home/ikostylev/robustEGMS/experiment_runners/choleskyDecomposition:$PYTHONPATH"
    ])
